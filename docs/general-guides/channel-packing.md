...
but they can be a bit finnicky, luckily Krita offers us a better way to pack our textures.
...
4. Export your texture:
   ...
   - If you do not uncheck the "Store Alpha Channel" your image may have blockyness when you import it into ue. 
     This is because we do not use the Alpha channel and if the alpha isn't premultiplied in if the RGB Channels are super clean when you export they will come out
